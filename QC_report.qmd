...
filtered_resmarker_table_path <- "resistance_marker_module/resmarker_table_filtered.txt"
filtered_resmarker_microhap_table_path <- "resistance_marker_module/resmarker_microhap_table_filtered.txt"
```
...
# Write out table
write.csv(resmarker_table_filtered, filtered_resmarker_microhaplotype_table_path, row.names = FALSE)
```
